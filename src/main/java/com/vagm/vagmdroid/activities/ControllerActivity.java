...
public class ControllerActivity extends CustomAbstractActivity implements OnClickListener {
    ...
    protected void onCreate(final Bundle savedInstanceState) {
        ...
        /*
         * if (BluetoothService.getInstance().getState() !=
         * ConnectionState.CONNECTED) { Toast.makeText(getApplicationContext(),
         * getText(R.string.connection_lost), Toast.LENGTH_SHORT).show();
         * stopTimer(); finish(); }
         */
