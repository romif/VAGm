		...
		try {
			if (errorCode < 1012) {
				inputStream = FaultCodesService.class.getClassLoader().getResourceAsStream(
						"assets" + File.separator + "DTC" + File.separator + "dtc.txt");
			} else {
				if (errorCode < 2012) {
					inputStream = FaultCodesService.class.getClassLoader().getResourceAsStream(
							"assets" + File.separator + "DTC" + File.separator + "dtc1.txt");
				} else {
					if (errorCode < 16361) {
						inputStream = FaultCodesService.class.getClassLoader().getResourceAsStream(
								"assets" + File.separator + "DTC" + File.separator + "dtc2.txt");
					} else {
						if (errorCode < 17878) {
							inputStream = FaultCodesService.class.getClassLoader().getResourceAsStream(
									"assets" + File.separator + "DTC" + File.separator + "dtc3.txt");
						} else {
							inputStream = FaultCodesService.class.getClassLoader().getResourceAsStream(
									"assets" + File.separator + "DTC" + File.separator + "dtc4.txt");
						}
					}
				}
			}
