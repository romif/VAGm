...
public class BluetoothCommandService extends Service{
    ...
    public static final String ACTION_FROM_SERVICE = "com.luugiathuy.apps.remotebluetooth.FROM_SERVICE";
...
//    private int mConnectionLostCount;
    ...
    private static BluetoothCommandService instance = null;
    ...
    public static BluetoothCommandService getInstance() {
    	if (instance == null) {
    		instance = new BluetoothCommandService();
    	}
    	return instance;
    }
    ...
    public void onCreate() {
        super.onCreate();
    	Log.d(TAG, "RemoteBluetooth onCreate");
      }
...
//                        .sendToTarget();
    ...
    public IBinder onBind(Intent arg0) {
        Log.d(TAG, "BluetoothCommandService onBind");
        return binder;
      }
